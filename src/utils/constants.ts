...
function deepFreeze<T extends object>(obj: T): ReadonlyDeep<T> {
  Object.keys(obj).forEach((prop) => {
    // @ts-expect-error: works on objects dude
...
export enum AUTOBUYER_MODE {
  BUY_SINGLE = 1,
  BUY_10 = 10,
  BUY_MAX = 100,
};

export enum AUTO_CRUNCH_MODE {
  AMOUNT = 0,
  TIME = 1,
  X_HIGHEST = 2,
};

export enum AUTO_ETERNITY_MODE {
  AMOUNT = 0,
  TIME = 1,
  X_HIGHEST = 2,
};

export enum AUTO_REALITY_MODE {
  RM = 0,
  GLYPH = 1,
  EITHER = 2,
  BOTH = 3,
...
export enum RECENT_PRESTIGE_RESOURCE {
  ABSOLUTE_GAIN = 0,
  RATE = 1,
  CURRENCY = 2,
  PRESTIGE_COUNT = 3,
...
export const GLYPH_MIME_TYPE = "text/x-ivark-glyph";

export enum GLYPH_BG_SETTING {
  AUTO = 0,
  LIGHT = 1,
  DARK = 2,
};
...
export enum BLACK_HOLE_PAUSE_MODE {
  NO_PAUSE = 0,
  PAUSE_BEFORE_BH1 = 1,
  PAUSE_BEFORE_BH2 = 2,
};

export enum GLYPH_SIDEBAR_MODE {
...
export enum AUTO_GLYPH_REJECT {
  SACRIFICE = 0,
  REFINE = 1,
  REFINE_TO_CAP = 2,
};

export enum TIME_STUDY_PATH {
  NONE = 0,
  ANTIMATTER_DIM = 1,
  INFINITY_DIM = 2,
  TIME_DIM = 3,
...
export enum TS_REQUIREMENT_TYPE {
  AT_LEAST_ONE = 0,
  ALL = 1,
  DIMENSION_PATH = 2,
};

export enum ALCHEMY_RESOURCE {
  POWER = 0,
  INFINITY = 1,
  TIME = 2,
  REPLICATION = 3,
...
export enum SINGULARITY_MILESTONE_RESOURCE {
  SINGULARITIES = 0,
  CONDENSE_COUNT = 1,
  MANUAL_TIME = 2,
  AUTO_TIME = 3,
...
export enum SINGULARITY_MILESTONE_SORT {
...
export enum COMPLETED_MILESTONES {
  FIRST = 0,
  LAST = 1,
  IGNORED = 2,
};
...
export enum SPEEDRUN_SEED_STATE {
  UNKNOWN = 0,
  FIXED = 1,
  RANDOM = 2,
  PLAYER = 3,
